...
use frontend\models\ConnectQuery;
use frontend\models\Cprofile;
use frontend\models\CprofileQuery;
use frontend\models\Pprofile;
use frontend\models\PprofileQuery;
use frontend\models\Project;
use frontend\models\ProjectQuery;
use Yii;
...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
    	return $this->hasMany(Connect::className(), ['user_id' => 'id']);
    }
    
    /**
     * Gets query for [[Cprofiles]].
     *
     * @return \yii\db\ActiveQuery|CprofileQuery
     */
    public function getCprofile()
    {
    	return $this->hasOne(Cprofile::className(), ['user_id' => 'id']);
    }
    
    /**
     * Gets query for [[Pprofiles]].
     *
     * @return \yii\db\ActiveQuery|PprofileQuery
     */
    public function getPprofile()
    {
    	return $this->hasOne(Pprofile::className(), ['user_id' => 'id']);
    }
